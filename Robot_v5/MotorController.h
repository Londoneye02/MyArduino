/*
	MotorController.h Clase creada para gestionar dos motores con un puenteH L298N.
	Contiene funciones de adelante, atras, etc.
*/
...
{
public:
MotorController(int PF0,int PF1,int PB0,int PB1,int PE0,int PE1,int MS0, int MS1,int MD0,int MD1);
